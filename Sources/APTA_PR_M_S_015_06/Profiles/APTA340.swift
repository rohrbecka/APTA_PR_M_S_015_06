...
internal struct APTA340: WheelProfile {
...
extension APTA340 {
    ...
    fileprivate var K: CGPoint {
        CGPoint(x: 33.7946, y: -16.9470)
    }

    fileprivate var L: CGPoint {
        CGPoint(x: 95.6566, y: -18.5280)
    }

    fileprivate var M: CGPoint {
        CGPoint(x: 106.4856, y: -23.1730)
    }

    fileprivate var N: CGPoint {
        CGPoint(x: 110.4666, y: -27.1540)
    }
}
...
extension APTA340 {
    ...
    fileprivate var centerJK: CGPoint {
        CGPoint(x: 39.2882, y: 92.9157)
    }

    fileprivate var centerLM: CGPoint {
        CGPoint(x: 95.2600, y: -34.3980)
    }
}
