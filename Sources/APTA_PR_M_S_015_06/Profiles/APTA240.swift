...
internal struct APTA240: WheelProfile {
...
extension APTA240 {
    ...
    fileprivate var J: CGPoint {
        CGPoint(x: 1.0148, y: -0.6556).inchToMm
    }

    fileprivate var K: CGPoint {
        CGPoint(x: 3.7344, y: -0.7236).inchToMm
    }

    fileprivate var L: CGPoint {
        CGPoint(x: 4.3437, y: -1.3483).inchToMm
    }
}
...
extension APTA240 {
    ...
    fileprivate var centerKL: CGPoint {
        CGPoint(x: 3.7187, y: -1.3484).inchToMm
    }
}
